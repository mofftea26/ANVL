...
export const ACT_PRESET_ALIASES: Record<string, string> = {
  ...
  threeCardEditorialGrid: 'oathEditorialThree',
  banners: 'oathBannerShowcase',
  kingdomBanners: 'oathBannerShowcase',
  carousel: 'oathProductCarousel',
  productCarousel: 'oathProductCarousel',
  spotlight: 'oathSpotlightRow',
  spotlightRow: 'oathSpotlightRow',

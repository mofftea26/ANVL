  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        kind: 'model',
        section: 'Altar finale (desktop 3D stage)',
        hint: '.glb, ~30k tris, < 5 MB. The altar finale’s centrepiece — desktop (≥1280px) only, prefetched ~2 chapters before the finale; never downloaded on mobile. Falls back to the bundled default anvil when unassigned.',
      },
      {
        key: 'hammerModel',
        ...
        kind: 'model',
        section: 'Altar finale (desktop 3D stage)',
        hint: '.glb, ~20k tris, < 4 MB. Swings onto the chosen orb — the strike scrolls back to that orb’s chapter. Falls back to the bundled default hammer when unassigned.',
      },
      {
        key: 'forgeBackdrop',
      ...
      },
      {
        ...
        kind: 'image',
        section: 'Creed',
        hint: '16:9 landscape, 2560×1440. Near-abstract smoke — The Creed chapter’s full-screen faded backdrop (film and static page alike). WebP ~70q, < 400 KB.',
      },
      {
        ...
        hint: '16:9 landscape, 2560×1440. Fabric weave macro — the Materials chapter’s full-screen faded backdrop. WebP ~80q, < 450 KB.',
      },
      {
        ...
        hint: '16:9 landscape, 2560×1440. Seam/stitch macro — the Construction chapter’s full-screen faded backdrop. WebP ~80q, < 450 KB.',
      },
      {
        key: 'testingBackdrop',
        label: 'Testing image',
        ...
        hint: '16:9 landscape, 2560×1440. Stress-test rig framing — the Testing chapter’s full-screen faded backdrop. WebP ~80q, < 450 KB.',
      },
      {
        key: 'finaleBackdrop',

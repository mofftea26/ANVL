...
describe('OathFinale', () => {
  ...
  it('scales the crest emblem prominently at every breakpoint', () => {
    ...
    expect(crestSizer!.className).toMatch(/\bh-44\b/)
    expect(crestSizer!.className).toMatch(/\bw-44\b/)
    expect(crestSizer!.className).toMatch(/\bmd:h-52\b/)
    expect(crestSizer!.className).toMatch(/\bmd:w-52\b/)
    expect(crestSizer!.className).toMatch(/\bxl:h-56\b/)
    expect(crestSizer!.className).toMatch(/\bxl:w-56\b/)

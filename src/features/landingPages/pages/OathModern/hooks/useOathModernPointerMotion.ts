 ...
 * velocity. The persistent scene lerps toward these (camera parallax + cursor
 * light) in `useFrame`; no React state, no re-renders. Skipped on coarse pointers
 * (touch uses scroll).
 */
export function useOathModernPointerMotion(

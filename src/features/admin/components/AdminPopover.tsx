...
const contentShell =
  'z-[100] flex max-h-[min(520px,var(--radix-popover-content-available-height))] flex-col overflow-y-auto rounded-lg border border-[var(--color-line)] bg-[var(--color-bg)] p-3 shadow-[inset_0_1px_0_rgba(231,228,223,0.06),0_16px_42px_rgba(0,0,0,0.55)] outline-none'

  ...
  return (
    <section
      className={cn(
        ...
        /* Forged plate: soft lift + inward specular rim */
        ...
        'motion-safe:transition-[box-shadow,border-color,transform] motion-safe:duration-300 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)]',
        'motion-reduce:transition-none',
        /* Hover affordance — no motion when reduced */

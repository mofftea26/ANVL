...
/**
 * /admin/passports — generate per-unit QR passports for a product, track
 * claimed vs unclaimed, unassign/delete, and print a batch QR sheet.
 */
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <AdminCard
          title="Forge a batch"
          description="Pick the product and how many physical units you are printing passports for. Serial numbers continue where the product's last batch ended."
        >
          <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_8rem_auto] sm:items-end">
            <AdminFieldSelect
              ...
              hint="Populated from the live commerce catalog."
            />

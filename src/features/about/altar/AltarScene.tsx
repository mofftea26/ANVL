 ...
 * color), the struck orb's ember disintegration, the shared cursor dust, and
 * the lighting rig. All per-frame motion reads the mutable {@link AltarState}
 * written by the GSAP strike timelines — zero React state in the loop.
 */

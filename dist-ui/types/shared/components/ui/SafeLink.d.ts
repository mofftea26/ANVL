...
import { type SanitizeHrefOptions } from '@/shared/lib/url';
/**
...
export type SafeLinkProps = {
    ...
    'aria-label'?: string;
} & Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'href' | 'children' | 'onClick' | 'className' | 'aria-label'>;
export declare function SafeLink({ href, children, className, onClick, sanitizeOptions, forceExternal, ...rest }: SafeLinkProps): import("react/jsx-runtime").JSX.Element;

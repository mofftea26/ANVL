...
src/
  ...
  features/
    ...
    cms/             Storefront-safe CMS reads: theme/font/asset config (cmsSiteConfig), landing content envelope, coming-soon config, banner/ (banner_config + SiteBannerRail above the topbar), publication readers, navigation + layout defaults, preview/ (admin live-preview bridge: protocol, PreviewDraftProvider, targets/highlight)
